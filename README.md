...
- UVN system works maybe for moving around a fixed stage in "orbit" mode or following a specific character (would be perfect for 3rd person perspective maybe) but maybe an Euler or Quaternion based camera system makes a bit more sense in some situations. Could be added.
